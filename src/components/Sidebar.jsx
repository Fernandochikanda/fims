...
export default function Sidebar({ currentUser, activePage, onNavigate, alertCount, isOpen, onClose }) {
  ...
  const navItems = [
    ...
    { id: "reports", icon: "chart", label: t.reports, roles: [ROLES.ADMIN, ROLES.CEO, ROLES.SUPERVISOR] },
    { id: "monthly_report", icon: "file", label: t.monthly_report, roles: [ROLES.ADMIN, ROLES.CEO, ROLES.SUPERVISOR] },
